...
(
    ...
    FOREIGN KEY (company_id) REFERENCES sql_course.company_dim (company_id)
);
...
ALTER TABLE sql_course.company_dim OWNER to postgres;
ALTER TABLE sql_course.skills_dim OWNER to postgres;
ALTER TABLE sql_course.job_postings_fact OWNER to postgres;
ALTER TABLE sql_course.skills_job_dim OWNER to postgres; 
...
used the following to do tables from scratch
